...
vgg_net = keras.applications.InceptionV3(include_top=False, input_tensor=x_tensor, weights="imagenet")

vgg_net.trainable = False
tranfer_learn_model = Sequential()
tranfer_learn_model.add(vgg_net)
...
tranfer_learn_model.save('InceptionV3_LeavesClassification_Tuned_16.h5')
