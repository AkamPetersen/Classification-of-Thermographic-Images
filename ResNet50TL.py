...
res_net = keras.applications.ResNet50(include_top=False, input_tensor=x_tensor, weights="imagenet")
...
tranfer_learn_model.save('ResNet50_LeavesClassification_Tuned_16.h5')
