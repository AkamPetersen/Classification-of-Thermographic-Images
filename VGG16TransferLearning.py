...
vgg_net = keras.applications.VGG16(include_top=False, input_tensor=x_tensor, weights="imagenet")
...
tranfer_learn_model.save('VGG16_LeavesClassification_Tuned_16.h5')
