...
res_net = keras.applications.EfficientNetB0(include_top=False, input_tensor=x_tensor, weights="imagenet")
...
tranfer_learn_model.save('EfficientNetB0_LeavesClassification_Tuned_16.h5')
