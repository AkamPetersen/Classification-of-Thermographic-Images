...
res_net = keras.applications.DenseNet121(include_top=False, input_tensor=x_tensor, weights="imagenet")
...
tranfer_learn_model.save('DenseNet121_LeavesClassification_Tuned_16.h5')
