...
res_net = keras.applications.EfficientNetB4(include_top=False, input_tensor=x_tensor, weights="imagenet")
...
tranfer_learn_model.save('EfficientNetB4_LeavesClassification_Tuned_16.h5')
